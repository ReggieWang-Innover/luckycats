    ...
    if ($_GET['act'] == 'asynclist') {
        ...
        if (is_array($goodslist)) {
            foreach ($goodslist as $vo) {
                ...
                $innerPro = '<div class="proImg-wrap"> <a href="' . $vo['url'] . '" > <img src="'
                    .$config['site_url'].$vo['goods_thumb'].'" alt="' . $vo['goods_name'].'"> </a> </div>'
                ...
                {
                    $innerPro .= 
                         '<div class="proPrice"><em>'. $shop_price .'</em></div>'
                    ...
                    $innerPro .= '<div class="proIcons">'.$vo['goods_brief'].'</div>';
                }
                
                $innerPro .= '</div>';
                
                $sayList[] = array('pro-inner' => $innerPro);
            }
        }
